...
Replaces `gen_atm_j70.F`, whose hand-rolled single-exponential temperature profile (forced 12 K/km gradient at 90 km) ran ~127 K too warm through 90–125 km and produced a table **3.3–3.5× denser than JacchiaRoberts across the 140–200 km perigee band** (OREM issues #12/#14/#25, 2026-07-14). Note: the earlier "drag ratio 95–97% vs NPOE" and the Phase-3 "~20% vs GMAT at Hp≈243 km" validations were both consistent with the old table because the perigee-band excess partially cancelled against a separate drag-model deficit now tracked as OREM #25 — at 243 km the old table's excess was only ~5%.
