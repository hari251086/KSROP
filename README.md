...
│   └── test_cunningham.F                 General tesseral harmonics tests (19 checks, issue #30)
...
```bash
make test       # build everything + run test_all.sh (579 checks + 5 lint rules)
```
...
**Total: 579 automated checks + 5 lint rules.**
